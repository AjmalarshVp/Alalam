export const translations = {
  en: {
    dir: "ltr",
    nav: { quote: "Get Quote", services: "Services", process: "Process", contact: "Contact", home: "Home", packages: "Packages", contactPage: "Contact Us" },
    contactPage: {
      overline: "Get In Touch",
      title: "Contact Al Alam Swimming Pools",
      subtitle: "Ready for crystal-clear water? Contact our experts today for professional swimming pool cleaning and maintenance services.",
      form: {
        title: "Send Us a Message",
        sub: "Our team will respond within one business hour.",
        name: "Full Name",
        phone: "Phone Number",
        email: "Email Address (Optional)",
        city: "City",
        poolType: "Pool Type",
        poolSize: "Pool Size (Optional)",
        service: "Interested Service",
        message: "Message (Optional)",
        submit: "Send Message",
        sending: "Sending…",
        success: "Thank you! Our team will be in touch with you shortly.",
        poolTypes: ["Villa / Private Pool", "Hotel / Resort", "Compound Pool", "Commercial Pool", "Other"],
        services: ["Weekly Care", "Premium Care", "Instant Cleaning", "Pool Maintenance", "Pool Cleaning", "General Inquiry"],
      },
      info: {
        ...
        email: "Email",
        area: "Service Area",
        areaValue: "Riyadh · Jeddah · Dammam · Kingdom-wide",
        hours: "Business Hours",
        hoursValue: "Sun – Thu: 8:00 AM – 6:00 PM",
        hoursNote: "Fri – Sat: By Appointment",
      },
      whatsappCard: {
        title: "Need immediate assistance?",
        sub: "Our team is ready to help you right now.",
        cta: "Chat on WhatsApp",
      },
      mapTitle: "Our Service Area",
      mapSub: "We serve Riyadh, Jeddah, Dammam, and across the Kingdom.",
    },
    hero: {
      badge: "🇸🇦 Saudi Arabia's Trusted Pool Experts",
      headline: ["30% OFF", "Instant Pool Cleaning", "At Your Doorstep in 30 Minutes"],
      sub: "Professional swimming pool cleaning and water treatment delivered by trained experts. Book today and enjoy a crystal-clear pool in just 30 minutes.",
      ctaPrimary: "Book Instant Cleaning",
  ...
  ar: {
    dir: "rtl",
    nav: { quote: "اطلب عرضاً", services: "الخدمات", process: "كيف نعمل", contact: "تواصل", home: "الرئيسية", packages: "الباقات", contactPage: "تواصل معنا" },
    contactPage: {
      overline: "تواصل معنا",
      title: "تواصل مع العالَم للمسابح",
      subtitle: "هل أنت مستعد لمياه نقية كالكريستال؟ تواصل مع خبرائنا اليوم للحصول على خدمة تنظيف وصيانة مسابح احترافية.",
      form: {
        title: "أرسل لنا رسالة",
        sub: "سيتواصل معك فريقنا خلال ساعة عمل واحدة.",
        name: "الاسم الكامل",
        phone: "رقم الهاتف",
        email: "البريد الإلكتروني (اختياري)",
        city: "المدينة",
        poolType: "نوع المسبح",
        poolSize: "حجم المسبح (اختياري)",
        service: "الخدمة المطلوبة",
        message: "رسالة (اختياري)",
        submit: "إرسال الرسالة",
        sending: "جارٍ الإرسال…",
        success: "شكراً لك! سيتواصل معك فريقنا قريباً.",
        poolTypes: ["فيلا / مسبح خاص", "فندق / منتجع", "مسبح مجمع", "مسبح تجاري", "أخرى"],
        services: ["الرعاية الأسبوعية", "الرعاية المميزة", "التنظيف الفوري", "صيانة المسبح", "تنظيف المسبح", "استفسار عام"],
      },
      info: {
        ...
        area: "نطاق الخدمة",
        areaValue: "الرياض · جدة · الدمام · المملكة كاملة",
        hours: "ساعات العمل",
        hoursValue: "الأحد – الخميس: 8:00 صباحاً – 6:00 مساءً",
        hoursNote: "الجمعة – السبت: بموعد مسبق",
      },
      whatsappCard: {
        title: "تحتاج مساعدة فورية؟",
        sub: "فريقنا جاهز لمساعدتك الآن.",
        cta: "تواصل عبر واتساب",
      },
      mapTitle: "منطقة خدمتنا",
      mapSub: "نخدم الرياض وجدة والدمام وجميع أنحاء المملكة.",
    },
    hero: {
      badge: "🇸🇦 خبراء المسابح الموثوقون في السعودية",
      headline: ["خصم 30%", "تنظيف فوري للمسبح", "عند بابك خلال 30 دقيقة"],
      sub: "تنظيف مسابح وعلاج مياه احترافي على يد خبراء متخصصين. احجز اليوم واستمتع بمسبح صافٍ كالكريستال خلال 30 دقيقة فقط.",
      ctaPrimary: "احجز التنظيف الفوري",
